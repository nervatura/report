	...
	vmap := map[string]map[string]func(value interface{}){
		"row": {
			"Height": func(value interface{}) {
				pi.Item.(*Row).Height = ToFloat(value, 0)
			},
			"HGap": func(value interface{}) {
				pi.Item.(*Row).HGap = ToFloat(value, 0)
			},
			"Visible": func(value interface{}) {
				pi.Item.(*Row).Visible = ToString(value, "")
			},
		},
		"cell": {
			"Name": func(value interface{}) {
				pi.Item.(*Cell).Name = ToString(value, "")
			},
			"Value": func(value interface{}) {
				pi.Item.(*Cell).Value = ToString(value, "")
			},
			"Width": func(value interface{}) {
				pi.Item.(*Cell).Width = ToString(value, "")
			},
			"Border": func(value interface{}) {
				pi.Item.(*Cell).Border = ToString(value, "")
			},
			"Align": func(value interface{}) {
				pi.Item.(*Cell).Align = ToString(value, "L")
			},
			"Multiline": func(value interface{}) {
				pi.Item.(*Cell).Multiline = ToBoolean(value, false)
			},
			"FontStyle": func(value interface{}) {
				pi.Item.(*Cell).FontStyle = ToString(value, "")
			},
			"FontSize": func(value interface{}) {
				pi.Item.(*Cell).FontSize = ToFloat(value, pi.Item.(*Cell).FontSize)
			},
			"TextColor": func(value interface{}) {
				pi.Item.(*Cell).TextColor = ToRGBA(value, pi.Item.(*Cell).TextColor)
			},
			"BorderColor": func(value interface{}) {
				pi.Item.(*Cell).BorderColor = ToRGBA(value, pi.Item.(*Cell).BorderColor)
			},
			"BackgroundColor": func(value interface{}) {
				pi.Item.(*Cell).BackgroundColor = ToRGBA(value, pi.Item.(*Cell).BackgroundColor)
			},
		},
		"image": {
			"Src": func(value interface{}) {
				pi.Item.(*Image).Src = ToString(value, "")
			},
			"Height": func(value interface{}) {
				pi.Item.(*Image).Height = ToFloat(value, 0)
			},
		},
		"barcode": {
			"CodeType": func(value interface{}) {
				pi.Item.(*Barcode).CodeType = ToString(value, "")
			},
			"Value": func(value interface{}) {
				pi.Item.(*Barcode).Value = ToString(value, "")
			},
			"VisibleValue": func(value interface{}) {
				pi.Item.(*Barcode).VisibleValue = ToBoolean(value, false)
			},
			"Width": func(value interface{}) {
				pi.Item.(*Barcode).Width = ToFloat(value, 0)
			},
			"Height": func(value interface{}) {
				pi.Item.(*Barcode).Height = ToFloat(value, 0)
			},
			"Extend": func(value interface{}) {
				pi.Item.(*Barcode).Extend = ToBoolean(value, false)
			},
		},
		"separator": {
			"Gap": func(value interface{}) {
				pi.Item.(*Separator).Gap = ToFloat(value, 0)
			},
		},
		"vgap": {
			"Height": func(value interface{}) {
				pi.Item.(*VGap).Height = ToFloat(value, 0)
			},
			"PageBreak": func(value interface{}) {
				pi.Item.(*VGap).PageBreak = ToBoolean(value, false)
			},
			"Visible": func(value interface{}) {
				// Deprecated
			},
		...
		"hline": {
			"Width": func(value interface{}) {
				pi.Item.(*HLine).Width = ToString(value, "")
			},
			"Gap": func(value interface{}) {
				pi.Item.(*HLine).Gap = ToFloat(value, 0)
			},
			"BorderColor": func(value interface{}) {
				pi.Item.(*HLine).BorderColor = ToRGBA(value, pi.Item.(*HLine).BorderColor)
			},
			"Visible": func(value interface{}) {
				// Deprecated
			},
		...
		"html": {
			"Fieldname": func(value interface{}) {
				pi.Item.(*HTML).Fieldname = ToString(value, "")
			},
			"Value": func(value interface{}) {
				pi.Item.(*HTML).Value = ToString(value, "")
			},
		},
		"datagrid": {
			"Name": func(value interface{}) {
				pi.Item.(*Datagrid).Name = ToString(value, "")
			},
			"Databind": func(value interface{}) {
				pi.Item.(*Datagrid).Databind = ToString(value, "")
			},
			"Width": func(value interface{}) {
				pi.Item.(*Datagrid).Width = ToString(value, "")
			},
			"Merge": func(value interface{}) {
				pi.Item.(*Datagrid).Merge = ToBoolean(value, false)
			},
			"Border": func(value interface{}) {
				pi.Item.(*Datagrid).Border = ToString(value, "1")
			},
			"FontSize": func(value interface{}) {
				pi.Item.(*Datagrid).FontSize = ToFloat(value, pi.Item.(*Datagrid).FontSize)
			},
			"TextColor": func(value interface{}) {
				pi.Item.(*Datagrid).TextColor = ToRGBA(value, pi.Item.(*Datagrid).TextColor)
			},
			"BorderColor": func(value interface{}) {
				pi.Item.(*Datagrid).BorderColor = ToRGBA(value, pi.Item.(*Datagrid).BorderColor)
			},
			"BackgroundColor": func(value interface{}) {
				pi.Item.(*Datagrid).BackgroundColor = ToRGBA(value, pi.Item.(*Datagrid).BackgroundColor)
			},
			"HeaderBackground": func(value interface{}) {
				pi.Item.(*Datagrid).HeaderBackground = ToRGBA(value, pi.Item.(*Datagrid).HeaderBackground)
			},
			"FooterBackground": func(value interface{}) {
				pi.Item.(*Datagrid).FooterBackground = ToRGBA(value, pi.Item.(*Datagrid).FooterBackground)
			},
		},
		"column": {
			"Fieldname": func(value interface{}) {
				pi.Item.(*Column).Fieldname = ToString(value, "")
			},
			"Label": func(value interface{}) {
				pi.Item.(*Column).Label = ToString(value, "")
			},
			"Width": func(value interface{}) {
				pi.Item.(*Column).Width = ToString(value, "")
			},
			"Align": func(value interface{}) {
				pi.Item.(*Column).Align = ToString(value, "L")
			},
			"HeaderAlign": func(value interface{}) {
				pi.Item.(*Column).HeaderAlign = ToString(value, "L")
			},
			"FooterAlign": func(value interface{}) {
				pi.Item.(*Column).FooterAlign = ToString(value, "L")
			},
			"Footer": func(value interface{}) {
				pi.Item.(*Column).Footer = ToString(value, "")
			},
		},
	}
...
type VGap struct {
	...
	PageBreak bool    `xml:"page-break,attr" json:"page-break"` //add a new page
}
...
func (rpt *Report) createDatagrid(gridElement *Datagrid, virtual bool) bool {
	...
	if strings.HasSuffix(gridElement.Width, "%") {
		headerOptions["gridWidth"] = nwidth * ToFloat(strings.Replace(gridElement.Width, "%", "", -1), 0) / 100
	} else {
		headerOptions["gridWidth"] = ToFloat(gridElement.Width, 0)
	...
	for index := 0; index < len(gridElement.Columns); index++ {
		...
		if !headerOptions["merge"].(bool) {
			...
			if columnWidth != "" {
				if strings.HasSuffix(columnWidth, "%") {
					columnOptions["columnWidth"] = headerOptions["gridWidth"].(float64) * ToFloat(strings.Replace(columnWidth, "%", "", -1), 0) / 100
				} else {
					columnOptions["columnWidth"] = ToFloat(columnWidth, 0)
				}
			} else {
		...
		columnOptions["headerAlign"] = ToString(column.HeaderAlign, "L")
		columnOptions["align"] = ToString(column.Align, "L")
...
func (rpt *Report) createCell(options IM) float64 {
	...
	fill := false
	backgroundColor := ToRGBA(options["backgroundColor"], rpt.BackgroundColor)
...
func (rpt *Report) createRow(section string, rowElement *Row, virtual bool) float64 {
	...
	for index := 0; index < len(rowElement.Columns); index++ {
		...
		case *Cell:
			...
			var xname = ToString(v.Name, "head")
...
func (rpt *Report) AppendElement(options ...interface{}) (*[]PageItem, error) {
	...
	if len(options) > 0 {
		...
		case string:
			...
			case "header":
				...
				if len(options) > 1 {
					...
					if Contains([]string{"row", "vgap", "hline"}, ename) {
			...
			case "details":
				...
				if len(options) > 1 {
					ename := ToString(options[1], "")
					if Contains([]string{"row", "vgap", "hline", "html", "datagrid"}, ename) {
						el, _ = rpt.getPageItem(ename)
					} else {
		...
		case *[]PageItem:
			...
			if len(options) > 1 {
				ename := ToString(options[1], "")
				if Contains([]string{"cell", "image", "barcode", "separator", "column"}, ename) {
					el, _ = rpt.getPageItem(ename)
				} else {
